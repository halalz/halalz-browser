...
const char kBraveUIWalletOnboardingURL[] = "halalz://wallet/crypto/onboarding";
const char kBraveUIWalletAccountCreationURL[] =
    "halalz://wallet/crypto/accounts/add-account/create/";
...
const char kExtensionSettingsURL[] = "halalz://settings/extensions";
const char kWalletSettingsURL[] = "halalz://settings/wallet";
...
const char kFederatedInternalsURL[] = "halalz://federated-internals";
